 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.a1.impl.SpecialisationImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecialisationImpl extends MinimalEObjectImpl.Container implements Specialisation {
	...
	protected EClass eStaticClass() {
		return A1Package.Literals.SPECIALISATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, A1Package.SPECIALISATION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case A1Package.SPECIALISATION__NAME:
				return getName();
		}
