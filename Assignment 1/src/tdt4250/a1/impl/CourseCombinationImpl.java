 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.a1.impl.CourseCombinationImpl#getCredits <em>Credits</em>}</li>
 *   <li>{@link tdt4250.a1.impl.CourseCombinationImpl#getCourses <em>Courses</em>}</li>
 *   <li>{@link tdt4250.a1.impl.CourseCombinationImpl#getSemester <em>Semester</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CourseCombinationImpl extends MinimalEObjectImpl.Container implements CourseCombination {
	...
	protected EClass eStaticClass() {
		return A1Package.Literals.COURSE_COMBINATION;
	}
	...
	public EList<Course> getCourses() {
		if (courses == null) {
			courses = new EObjectResolvingEList<Course>(Course.class, this, A1Package.COURSE_COMBINATION__COURSES);
		}
		return courses;
	}
	...
	public Semester getSemester() {
		if (eContainerFeatureID() != A1Package.COURSE_COMBINATION__SEMESTER) return null;
	...
	public NotificationChain basicSetSemester(Semester newSemester, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSemester, A1Package.COURSE_COMBINATION__SEMESTER, msgs);
		return msgs;
	}
	...
	public void setSemester(Semester newSemester) {
		if (newSemester != eInternalContainer() || (eContainerFeatureID() != A1Package.COURSE_COMBINATION__SEMESTER && newSemester != null)) {
			...
			if (newSemester != null)
				msgs = ((InternalEObject)newSemester).eInverseAdd(this, A1Package.SEMESTER__COURSE_COMBINATION, Semester.class, msgs);
			msgs = basicSetSemester(newSemester, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, A1Package.COURSE_COMBINATION__SEMESTER, newSemester, newSemester));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case A1Package.COURSE_COMBINATION__SEMESTER:
				return eInternalContainer().eInverseRemove(this, A1Package.SEMESTER__COURSE_COMBINATION, Semester.class, msgs);
		}
